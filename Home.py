...
# Page configuration
st.set_page_config(layout='wide', page_title='COVID-19 Across the World')
...
def main():
    ...
    COVID-19 Across the World is a data explorer for COVID-19 on both a global scale as well as on the country-level. This tool provides a number of key COVID-19 metrics and showcases them in an easy-to-understand, streamlined way. 

    We also dive deeper into investigating which metrics have the greatest effect on the spread of COVID-19 around the world by examining trends between countries.

    For more information, please visit our GitHub repository [here](https://github.com/jamesinjune/COVID_19_Data_Exploration/tree/main).

    For more projects from me, please visit my GitHub at [jamesinjune](https://github.com/jamesinjune).
    '''
    )
    ...
    - Python (plotly), Streamlit - [Visualizations](https://github.com/jamesinjune/COVID_19_Data_Exploration/blob/main/COVID_Visualizations.ipynb)
    ...
    ### Acknowledgements
    - Concept and visualizations inspired by [this notebook](https://www.kaggle.com/code/imdevskp/covid-19-analysis-visualization-comparisons/notebook) on Kaggle. 
    However, this project delves deeper into examining data from individual countries, as well as various factors at play in affecting the spread of COVID across the world.
